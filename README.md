...
UNION combina doius ou mais resultados de um select em um resultado apenas
LEMBRANDO ter a mesma quantidade de colunas e  o mesmo tipo de DADOS*/
...
-- UNION ALL tras ate mesmo os dados duplicados
...
-- TRAZER EM MAIUSCULO UPPER
-- TRAZER em minusculo LOWER
...
SELF JOIN AGRUPAR/ORDENAR OS DADOS DENTRO DE UMA MESMA TABELA mas pra
isso é necessario usar ALIAS = AS  EXEMPLO tabela1 AS "NOME" */
...
-- Boleano pode padrao ele inicialzado como NUL, e pode receber 1 ou 0
...
Caracteres tamanho fixo - char // permite inserir ate uma quantidade fixa de caracteres  sempre ocupa doto o espaço reservado.
   ...
   só usa o espaço que for preenchido utilizando por exemlo 10 de 50 
    ...
    Numeros
   VALORES EXATOS:
   TYNYINT - Não tem valor fracionado (exe: 1.43, 24.23) somente 1,1232123, 
   324234, 6545848 etc...
...
DROP TRIGGER TRG_ATUALIZA_PRECO_AO_CADASTRAR
...
INSERT INTO FRUTAS VALUES ('BANANA', 'CITRICAS', '2025-04-04') 

 UPDATE PRECOS SET PRECO = 8


SELECT * FROM PRECOS

INSERT INTO PRECOS VALUES (11.00, 8)
GO

DROP TRIGGER TRG_DELETA_PRECO_AO_CADAtradar
